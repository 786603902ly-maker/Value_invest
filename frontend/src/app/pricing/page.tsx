...
const FEATURES: Record<string, { zh: FeatureItem[]; en: FeatureItem[] }> = {
  ...
  pro: {
    zh: [
      ...
      { text: "Telegram 实时推送（持续更新加强中）", included: true },
    ...
    en: [
      ...
      { text: "Telegram real-time alerts (continuously improving)", included: true },
...
export default function PricingPage() {
  ...
  const comparisonRows: [string, boolean | string, boolean | string][] = [
    ...
    [zh ? "Telegram 推送 🔧" : "Telegram alerts 🔧", false, zh ? "持续加强中" : "Improving"],
