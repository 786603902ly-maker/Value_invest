...
const translations = {
  zh: {
    ...
    "pricing.pro.desc": "活跃投资者的完整分析",
    "pricing.pro.cta": "订阅专业版",
    "pricing.premium.name": "旗舰版",
    "pricing.premium.price": "¥139",
    "pricing.premium.period": "/月",
    "pricing.premium.desc": "严肃投资者的无限功能",
    "pricing.premium.cta": "升级旗舰版",
    "pricing.feature.stocks3": "3 只股票关注列表",
    "pricing.feature.stocks20": "20 只股票关注列表",
    "pricing.feature.stocksUnlimited": "无限股票关注列表",
    "pricing.feature.yahoo": "Yahoo Finance 数据",
    "pricing.feature.allSources": "Yahoo Finance + FMP 双源数据",
    "pricing.feature.basicChart": "基础偏离度图表",
    "pricing.feature.allCharts": "全部图表类型",
    "pricing.feature.alerts5": "5 个邮件提醒",
    "pricing.feature.alertsUnlimited": "无限提醒（邮件 + Telegram）",
    "pricing.feature.export": "CSV 数据导出",
    "pricing.feature.refresh15": "15 分钟数据刷新",
    "pricing.feature.refresh5": "5 分钟数据刷新",
    "pricing.feature.api": "REST API 接口",
    "pricing.feature.support": "优先客服支持",
    "pricing.feature.community": "社区交流",
    "pricing.faq.title": "常见问题",
    "pricing.faq.q1": "数据来自哪里？",
    "pricing.faq.a1": "我们聚合来自 Yahoo Finance（分析师共识、远期 P/E、PEG）和 Financial Modeling Prep（DCF 模型、分析师估值）的数据。专业版和旗舰版用户可获取双源数据。",
    "pricing.faq.q2": "可以随时取消吗？",
    "pricing.faq.a2": "当然！所有订阅均为月度付费，无合同约束。随时可在账户设置中取消。",
    "pricing.faq.q3": "数据多久刷新一次？",
    "pricing.faq.a3": "免费版数据缓存 1 小时。专业版每 15 分钟刷新。旗舰版用户享有 5 分钟刷新间隔。",
  ...
  en: {
    ...
    "pricing.pro.desc": "Full analysis for active investors",
    "pricing.pro.cta": "Subscribe Pro",
    "pricing.premium.name": "Premium",
    "pricing.premium.price": "$19.99",
    "pricing.premium.period": "/month",
    "pricing.premium.desc": "Unlimited power for serious investors",
    "pricing.premium.cta": "Go Premium",
    "pricing.feature.stocks3": "3 stocks in watchlist",
    "pricing.feature.stocks20": "20 stocks in watchlist",
    "pricing.feature.stocksUnlimited": "Unlimited watchlist",
    "pricing.feature.yahoo": "Yahoo Finance data",
    "pricing.feature.allSources": "Yahoo Finance + FMP data",
    "pricing.feature.basicChart": "Basic deviation chart",
    "pricing.feature.allCharts": "All chart types",
    ...
    "pricing.feature.refresh15": "15-min data refresh",
    "pricing.feature.refresh5": "5-min data refresh",
    "pricing.feature.api": "REST API access",
    ...
    "pricing.faq.a1": "We aggregate data from Yahoo Finance (analyst consensus, forward P/E, PEG) and Financial Modeling Prep (DCF models, analyst estimates). Pro and Premium users get data from both sources.",
    ...
    "pricing.faq.q3": "How often is data refreshed?",
    "pricing.faq.a3": "Free tier caches data for 1 hour. Pro refreshes every 15 minutes. Premium users get 5-minute refresh intervals.",
